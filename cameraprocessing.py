...
def CameraCapture(cap, angles_vec):
        ...
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                if (leg_to_analyze == 'left'):
                    ...
                    image, angle = displayVisualization(left_knee_landmarks, leg_connections, image, results)
                elif (leg_to_analyze == 'right'):
                    leg_connections = (leg_connections[0], leg_connections[1])
                    image, angle = displayVisualization(right_knee_landmarks, leg_connections, image, results)
